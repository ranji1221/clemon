...
<div class="container-fluid">
	...
	<div class="row resources_content form_content" u_id="1">
		<form action="">
			...
			<div action="" class="form-horizontal col-lg-8 col-md-8 col-sm-9 col-xs-12">
				<div class="form-group">
					...
					<div class="col-lg-8 col-md-7 col-sm-6 col-xs-6 form_input col-lg-offset-1 col-md-offset-1 col-sm-offset-0  res_name sliderInput">
						<input type="text" maxlength="15" name="name" class="form-control resources_name" placeholder="请输入资源名称">
		...
		<div class="row resources_remarks">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-7 resources_write">
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 res_checked">
					<label>
                    <input tabindex="2" type="checkbox" name="look"  checked>
                    <p>查看</p>
                    </label>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3  res_checked">
					<label>
                    <input tabindex="2" type="checkbox" name="add"  >
                    <p>增加</p>
                    </label>
				</div>
				<div class="col-lg-2 col-md-2  col-sm-3 col-xs-3 res_checked">
					<label>
                    <input tabindex="2" type="checkbox"  name="change" >
                    <p>更改</p>
                    </label>
				</div>
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 res_checked">
					<label>
                    <input tabindex="2" type="checkbox" name="del" id="input-2" >
                    <p>删除</p>
                    </label>
				</div>
			</div>
